<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div @click="changeAddress(address,addressList)" class="address clearFix" v-for="address in addressList" :key="address.id">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.sourceId">
          <li>
