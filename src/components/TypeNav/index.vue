<template>
  <!-- 商品分类导航 -->
  <div class="type-nav">
    <div class="container" @mouseleave="leaveCurrent" @mouseenter="enterShow">
...
export default {
  ...
  methods: {
    ...
    goSearch(event) {
      // 通过自定义属性data-categroyName来过滤a标签，
      //通过data-categroy1Id、data-categroy12d、data-categroy3Id来确认是1、2、3级标签
